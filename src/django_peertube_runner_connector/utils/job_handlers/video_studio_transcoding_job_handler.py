...
# https://github.com/Chocobozzz/PeerTube/blob/develop/server/server/lib/runners/job-handlers/video-studio-transcoding-job-handler.ts


class VideoStudioTranscodingJobHandler(AbstractJobHandler):
    """Handler for video studio transcoding jobs."""
